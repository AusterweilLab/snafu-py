...
p1 <- ggplot(dat, aes(x=subjects,y=cost_p,color=method)) + geom_line()
p2 <- ggplot(dat, aes(x=subjects,y=hit_p,color=method)) + geom_line()
p3 <- ggplot(dat, aes(x=subjects,y=fa_p,color=method)) + geom_line()
grid.arrange(p1,p2,p3,ncol=3)
