...
galist=[genG(numnodes,numlinks,probRewire) for i in range(100)]
...
r0=sum([rank[i][0] for i in range(100)])/100.0
r1=sum([rank[i][1] for i in range(100)])/100.0
r2=sum([rank[i][2] for i in range(100)])/100.0
