...
def main():
    ...
    with open("demos_test_data/uinvite_network1.pkl", "wb") as f:
    ...
    with open("demos_test_data/individual_graphs.pkl", "wb") as f:
    ...
    with open("demos_test_data/group_network.pkl", "wb") as f:
