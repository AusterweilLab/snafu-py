...
priordict = rw.genGraphPrior(graphs, [prior_items]*50, fitinfo=fitinfo) # BB(1,1) ensures no bias in aggregating network
...
with open('invitemethods_theta.csv','w',0) as fh:
