...
for subj in subs:
    ...
    # u-invite
    uinvite_prior_graph, bestval=rw.uinvite(Xs, toydata, numnodes, fitinfo=fitinfo, prior=prior)
    ...
    rw.write_csv([g, g2],subj+"usf_sparse.csv",subj) # write multiple graphs
