...
STATS_PATH = "static_input/stats.csv"  # CSV with expected values
SEMANTIC_INTRUSIONS_PATH = "static_input/intrusions_list.pkl"
LETTER_INTRUSIONS_PATH = "static_input/intrusions_list_letter_a.pkl"
